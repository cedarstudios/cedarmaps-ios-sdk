...
// CedarMap
#define COCOAPODS_POD_AVAILABLE_CedarMap
#define COCOAPODS_VERSION_MAJOR_CedarMap 0
#define COCOAPODS_VERSION_MINOR_CedarMap 0
#define COCOAPODS_VERSION_PATCH_CedarMap 1
...
#define COCOAPODS_VERSION_MINOR_Mapbox_iOS_SDK 5
