...
- (void)computeDirectionsFromSource:(CLLocation *)source toDestination:(CLLocation *)destination {
	...
	[[CSMapKit sharedMapKit] calculateDirectionsFromSource:source toDestinations:@[destination] withCompletionHandler:^(NSArray<CSRoute *> * _Nullable routes, NSError * _Nullable error) {
